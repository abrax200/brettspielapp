    ...
    return(
        ...
        <div className="search_container">
            ...
            <form onSubmit={handleSubmit} className="searchbar_form">
                <input type="text" autoComplete="off" placeholder="Suche" spellCheck="false" id="searchform_input" className="searchbar"/>
            </form>
            {/* filterknopf */}
            ...
            <FilterForm onChange={(e) => setGames(Dataset.hasCriterias(e.current.value))} expanded={filterExpanded}></FilterForm>
        </div>
